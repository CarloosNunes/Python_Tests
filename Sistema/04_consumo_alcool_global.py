...
df = pd.read_csv('D:/Clarify/Carlos Nunes/PythonAvançado/drinks.csv')

# criar o banco de dados em sql e popular com os dados do arquivo csv
conn = sqlite3.connect('D:/Clarify/Carlos Nunes/PythonAvançado/consumo_alcool.db')
...
<h2> Parte 02 </h2>
    <ul>
        ...
        <li><a href="/apagar_avengers"> Apagar Tabela Avengers </ax/li>
...
def grafico3():
    ...
    for regiao, paises in regioes.items():
        ...
        query = f"""
            SELECT SUM(total_litres_of_pure_alcohol) as total drinks WHERE country IN ({placeholders})
        """
